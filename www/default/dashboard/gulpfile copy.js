...
task(
  ...
  series(
    ...
    (done) => {
      const xtras = [
        './_src/js/lib/lodash.js',
        './_src/js/lib/epi-highmaps.js',
        './_src/js/lib/epi.utility.js',
        './_src/js/lib/highcharts-data.js',
        './_src/js/lib/highmaps-us-all-all.js',
        './_src/js/lib/highmaps.js',
        './_src/js/lib/highcharts-fbc.js',
        './_src/js/lib/knockout.min.js',
